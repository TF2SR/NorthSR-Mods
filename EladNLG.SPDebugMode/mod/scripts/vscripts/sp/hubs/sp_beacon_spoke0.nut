...
{
    DebugMode_CreateObjective( "b2Trig", "beacon2Triggers", 0, 99 )
...
{
	DebugMode_SetProgress("b2Trig", 1)
...
{
	DebugMode_SetProgress("b2Trig", 2)
...
{
	DebugMode_SetProgress("b2Trig", 3)
...
{
	DebugMode_SetProgress("b2Trig", 4)
...
{
	DebugMode_SetProgress("b2Trig", 5)
...
{
	DebugMode_SetProgress("b2Trig", 6)
	printt( "Fan Wallrun" )
